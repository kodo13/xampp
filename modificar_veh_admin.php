    ...
    echo "
        <html>
            ...
            <body>
                ...
                <h2>Páxina de modificación de vehículos</h2>

                <form name='mod_veh_aluguer' method='POST' action='modificar_veh_admin.php'>
                    
                    <p>Modelo <input type='text' name='modelo_modificar' placeholder='Introduzca modelo a modificar' value=''> </p>
                    <br/><br/>
...
if (isset($_REQUEST['mod_veh'])){
    ...
    $modelo= $_REQUEST['modelo_modificar'];
    ...
    if ($num_filas > 0){
        ...
        echo "Se desexa introducir un novo vehículo, selcciona o botón de <b>Añadir novos vehículos para alugar</b> do menú admin.</br>";
