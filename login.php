...
#Recollemos os datos introducido no login
...
#Comprobamos que se completasen os 2 campos
if (!empty($usuario) && !empty($contrasinal)){
    ...
    if ($num_filas > 0) {
        ...
        #Comprobamos si existe el par de usuario y contraseña y si es admin
